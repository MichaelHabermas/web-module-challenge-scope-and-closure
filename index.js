...
/*Task 1: counterMaker()
  ...
  Counter 2 will continuously reference its global variable (as can any other function operation). 
  counter1 creates a piece of memory and count that is only available to itself 

  2. Which of the two uses a closure? How can you tell?
  counter1. references another function that contains a function

  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  
     The second is good if you want to coordinate 1 counter with many different processes. The first allows each to have its own counter
